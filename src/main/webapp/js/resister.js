    ...
    $.ajax({
      ...
      success : function(obj){
        ...
        for(var i=0;i<result.data.list.length;i++){
          ...
          str += "<tr> <td><img class='myteamimage' src='"+photo+"'></td> <td><span class='mynickname'>"+result.data.list[i].nickname+"</span></td> <td><span class='myposition'>"+position+"</span></td></tr>"
        }
        $(".team_member").html(str);
      }
    })
   }
              ...
              if(result2.state !== "success"){
                ...
                if(result.data[0].team_no1 === result2.data.tno){
                  ...
                  if (result.data[0].team_no2 !== 0) {
                   ...
                   $("#team_number").val(result.data[0].rule);
                   $("#team_number").attr("disabled","true");
                   $("#memo_area").val(result.data[0].match_desc);
                   $("#memo_area").attr("disabled","true");
                   $(".resister_btn").hide();
                   $(".update_btn").hide();
                   $(".delete_btn").hide();
                   $(".battle_btn").hide();
                  ...
                  $(".update_btn").hide();
                  $(".delete_btn").hide();
                  ajaxRightTeam(result2.data.tno);
                }
            }
          })
        }
